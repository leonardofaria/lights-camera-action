        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <form className="relative w-64" onSubmit={handleSubmit}>
              <input name="query" type="search" onChange={handleInputChange} className="bg-gray-500 focus:bg-gray-200 transition duration-300 ease-in-out shadow rounded border-gray-900 w-full p-3" placeholder="Search + <enter>" />
